...
export async function sendBookingConfirmationEmail(
  ...
  const { serviceTitle, date, time, totalPrice } = bookingDetails;
...
<body style="margin:0;padding:0;background-color:#0d0d0d;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
          ...
          <tr>
            <td style="background-color:#A30A24;padding:32px 24px;text-align:center;">
              ...
              <h2 style="margin:0;font-size:28px;font-weight:800;color:#F7F5F2;letter-spacing:-0.5px;">
                You're on the books, ${customerName.split(" ")[0]}.
              </h2>
            ...
            <td style="background-color:#1a1a1a;padding:32px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
                <tr>
                  ...
                  <td align="right" style="font-size:14px;font-weight:700;color:#F7F5F2;">${serviceTitle}</td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
                <tr>
                  ...
                  <td align="right" style="font-size:14px;font-weight:700;color:#F7F5F2;">${date}</td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
                <tr>
                  ...
                  <td align="right" style="font-size:14px;font-weight:700;color:#F7F5F2;">${time}</td>
                </tr>
              </table>
  ...
  const mailOptions = {
    ...
    to,
    subject: `Booking Confirmed — ${serviceTitle} on ${date}`,
    html,
  };
